...
import '../[account_id]/notes/[article_id]/article.css'
...
const PreviewPage = async ({ searchParams }: PreviewPageProps) => {
    ...
    const { data: post } = await supabase
        .from('posts')
        .select(
            'article_id, title, content, created_at, read_time, thumbnail_url, approval_status, published, profiles!author_id (display_name, account_id, avatar_url)',
        )
